            ...
            <form action="proses.php?aksi=ubah" method="post">
                ...
                <div class="from-group">
                    ...
                    <div class="from-check">
                        <input type="radio" class="from-check-input" name="jenis_kelamin" value="L" id="laki" 
                            <? if ($row['jenis_kelamin'] === 'L') echo 'checked'; ?>required>
                        <label class="from-check-input" for="laki">Laki-laki</label>
                    </div>
                    <div class="from-check">
                        <input type="radio" class="from-check-input" name="jenis_kelamin" value="P" id="perempuan" 
                            <? if ($row['jenis_kelamin'] === 'P') echo 'checked'; ?>required>
                        <label class="from-check-input" for="perempuan">Perempuan</label>
                    </div>
                </div>
                <div class="from-group">
