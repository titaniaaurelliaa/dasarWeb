...
<html>
    <head>
        ...
        <!-- font awesome -->
        <link rel="stylesheet" href="https://use.fontawesome/releses/v5.7.2/css/all.css" integrity="sha384- fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
        <!-- data table -->
        <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net1.10.19/css/dataTables.bootstrap4.min.css">
    ...
    <body>
        ...
        <div class="container">
            <h2 align="center" style="margin: 38px;">Data Anggota</h2>
            ...
            <form method="post" class="form-data" id="form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="no_telp" id="no_telp" class="form-control" required="true"></textarea>
        ...
        <script type="text/javascript">
            ...
            // Event click pada tombol simpan
